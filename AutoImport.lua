...
-- Функция автоматического импорта событий текущего месяца
function Ahoydar:AutoImportCalendarEvents()
    ...
    print("Автоматический импорт событий текущего месяца завершён!")
    Ahoydar:UpdateCalendar()
end

-- Фрейм для отслеживания входа в игру и автоматического запуска импорта через 20 секунд
